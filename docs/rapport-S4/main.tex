...
\begin{itemize}
  \item \textbf{Spring Boot} --- Passage en version \texttt{3.4.5}.
  \item \textbf{PostgreSQL Driver} --- Mise \`{a} jour en \texttt{42.7.7}.
  \item \textbf{Dependency Management} --- Surcharge explicite des versions de \texttt{tomcat-embed-core} (10.1.35) et \texttt{spring-security} (6.4.6) pour garantir la r\'{e}solution des CVE-2025-24813 et CVE-2026-22732.
\end{itemize}
